...
Invoke-Step "ESLint" {
  npm.cmd run lint -- `
    ...
    src/lib/commerce-remix-engine.ts `
    ...
    __tests__/commerce-remix-engine.test.ts `
...
Invoke-Step "ESLint commerce remix API" {
  npm.cmd run lint -- src/app/api/commerce-remix/route.ts __tests__/commerce-remix-route.test.ts
}
