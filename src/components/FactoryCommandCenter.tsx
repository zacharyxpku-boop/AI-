...
export function FactoryCommandCenter({
  ...
  return (
    <div className="relative flex shrink-0 items-center gap-2">
      <button
        className="flex min-h-10 min-w-[220px] items-center gap-2 rounded-full border border-slate-200 bg-white px-4 text-left text-sm font-bold text-slate-500 shadow-sm transition hover:border-indigo-200 hover:text-slate-800"
